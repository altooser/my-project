$(document).ready(function() {
	$(".arr").click(function(){
		if($(this).parent().children(".cats-content").is(':visible')){
			$(this).parent().children(".cats-content").slideUp();
			$(this).parent().children(".cats-arr").slideUp();
			$(".cats-item").children().removeClass("active");
		}
		else {
		$(".cats-content, .cats-arr").hide();
		$(".cats-item").children().removeClass("active");
		$(this).parent().addClass("active");
		$(this).parent().children(".cats-content").slideDown();
		$(this).parent().children(".cats-arr").slideToggle();
		}
	});
